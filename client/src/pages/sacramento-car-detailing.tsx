        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              Sacramento, CA Mobile Car Detailing Services
            </h1>
            <p className="text-xl text-gray-200 mb-8 speakable-content">
              Hardys Wash N' Wax brings premium mobile car detailing directly to you in Sacramento, California. 
              We serve the entire Sacramento area, including Midtown, Downtown, East Sacramento, and all residential neighborhoods.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-[#F3F4E6] rounded-lg overflow-hidden shadow-md">
              <div className="p-6">
                ...
                <p className="text-gray-700 mb-4">
                  Perfect for busy Sacramento professionals. A thorough exterior wash, tire 
            ...
            <div className="bg-[#F3F4E6] rounded-lg overflow-hidden shadow-md">
              <div className="p-6">
                ...
                <p className="text-gray-700 mb-4">
                  Our most popular package in Sacramento. Complete interior and exterior detailing with clay 
            ...
            <div className="bg-[#F3F4E6] rounded-lg overflow-hidden shadow-md">
              <div className="p-6">
                ...
                <p className="text-gray-700 mb-4">
                  Premium protection against the Sacramento climate. Long-lasting shine 
